...
/**
 * @file This is a dump of a LLVM version of arm_acle.h. This is used to prevent
 * clangd to parse GCC version of arm_acle.h.
 * 
 * The header gard has been modified from __ARM_ACLE_H (llvm) to _GCC_ARM_ACLE_H (GNU)
 * to prevent the include of GNU's arm_acle.h content.
 * 
